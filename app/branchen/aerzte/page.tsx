...
export const metadata: Metadata = {
  title:
    "Bewertungsmanagement für Arztpraxen | Mehr Google-Bewertungen | Revalo",
  description:
    "77% der Patienten lesen Bewertungen vor der Arztwahl. Revalo hilft Arztpraxen, zufriedene Patienten automatisch zu Google-Bewertungen zu leiten und negatives Feedback intern zu fangen.",
  keywords:
    "bewertungsmanagement ärzte, google bewertungen arztpraxis, patientenbewertungen, arzt bewertungen verbessern, online reputation arzt",
  alternates: { canonical: "/branchen/aerzte" },
  openGraph: {
    title:
      "Bewertungsmanagement für Arztpraxen | Mehr Google-Bewertungen | Revalo",
    description:
      "77% der Patienten lesen Bewertungen vor der Arztwahl. Smart-Routing leitet zufriedene Patienten zu Google — negatives Feedback bleibt intern.",
    url: "https://getrevalo.de/branchen/aerzte",
    type: "website",
    locale: "de_DE",
    siteName: "Revalo",
  },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Ja. Alle Daten werden auf Servern in der EU gespeichert. Wir verarbeiten nur die minimal notwendigen Daten (Name und Kontaktweg) und bieten vollständige Transparenz. Es werden keine Gesundheitsdaten erhoben.",
  },
  {
    q: "Wie erhalten Patienten die Bewertungsanfrage?",
    a: "Je nach Ihrer Einstellung per WhatsApp, E-Mail oder QR-Code. WhatsApp hat die höchste Öffnungsrate (90%+). QR-Codes im Wartebereich sind ideal für Patienten vor Ort. E-Mail eignet sich als Follow-up 24 Stunden nach dem Termin.",
  },
  {
    q: "Funktioniert Revalo mit meiner Praxissoftware?",
    a: "Ja. Revalo arbeitet unabhängig von Ihrer Praxisverwaltungssoftware. Sie können Bewertungsanfragen manuell über das Dashboard versenden oder QR-Codes in der Praxis auslegen. Für größere Praxen bieten wir API-Integrationen an.",
  },
  {
    q: "Was kostet Revalo für Arztpraxen?",
    a: "Wir bieten individuelle Pakete je nach Praxisgröße und Patientenvolumen. Fordern Sie ein unverbindliches Angebot an — wir beraten Sie persönlich.",
  },
  {
    q: "Verstoße ich gegen Google-Richtlinien?",
    a: "Nein. Smart-Routing ist Google-konform, weil alle Patienten die gleiche Möglichkeit erhalten, Feedback zu geben. Kein Patient wird am Bewerten gehindert. Details dazu finden Sie in unserem Artikel zu Review Gating vs. Smart Routing.",
  },
];
...
export default function AerztePage() {
  const appSchema = {
    ...
    name: "Revalo für Arztpraxen",
    applicationCategory: "BusinessApplication",
    description:
      "Bewertungsmanagement-Software für Arztpraxen. Automatisiert den Prozess, zufriedene Patienten zu Google-Bewertungen zu leiten und negatives Feedback intern aufzufangen.",
    operatingSystem: "Web",
    offers: {
      "@type": "Offer",
      price: "0",
    ...
    <>
      ...
      <section className="relative overflow-hidden pb-20 pt-32 sm:pb-28 sm:pt-40">
        ...
        <div className="relative mx-auto max-w-4xl px-6">
          ...
          <nav className="mb-8 flex items-center gap-2 text-sm text-slate-500">
            ...
            <span>/</span>
            <span className="text-slate-400">Arztpraxen</span>
          </nav>
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-400 sm:text-xl">
              77% der Patienten lesen Online-Bewertungen vor der Arztwahl. Mit
              Revalo verwandeln Sie zufriedene Patienten automatisch in
              5-Sterne-Bewertungen — und fangen negatives Feedback intern ab.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Das Bewertungsproblem in Arztpraxen
            </h2>
            <p className="mt-4 text-lg text-slate-400">
              Die meisten Arztpraxen verlieren täglich potenzielle Neupatienten
              — weil ihr Google-Profil nicht die Realität widerspiegelt.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Zufriedene schweigen",
                desc: "Zufriedene Patienten vergessen eine Bewertung zu schreiben. Nur unzufriedene Patienten sind motiviert genug, ihren Frust auf Google loszuwerden.",
              },
              {
                icon: <IconStar className="h-6 w-6 text-red-400" />,
                title: "Eine Bewertung reicht",
                desc: "Eine einzige 1-Stern-Bewertung kann Ihren Gesamtschnitt um bis zu 0,5 Punkte senken — besonders wenn Sie noch wenige Bewertungen haben.",
              },
              {
                icon: <IconClock className="h-6 w-6 text-sky-400" />,
                title: "Kein System vorhanden",
                desc: "Im Praxisalltag fehlt die Zeit, jeden Patienten persönlich um eine Bewertung zu bitten. Ohne Prozess passiert — nichts.",
              },
            ].map((item) => (
              <div
                key={item.title}
          ...
          <div className="mx-auto mt-12 max-w-xl rounded-2xl border border-sky-500/20 bg-sky-500/5 p-6 text-center">
            <p className="text-lg font-semibold text-white">
              Eine Arztpraxis mit 4,5+ Sternen erhält bis zu{" "}
              <span className="text-sky-400">28% mehr Neupatientenanfragen</span>
            </p>
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Wie Revalo für Arztpraxen funktioniert
            </h2>
            <p className="mt-4 text-lg text-slate-400">
              Drei Schritte — vollautomatisch nach jedem Patientenbesuch.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Nach dem Patientenbesuch erhält der Patient automatisch eine freundliche Anfrage — per WhatsApp, E-Mail oder QR-Code im Wartebereich.",
                },
                {
                  step: "2",
                  title: "Patient bewertet",
                  desc: "Der Patient gibt auf einer einfachen Skala von 1-5 Sternen an, wie zufrieden er mit dem Besuch war. Dauert nur wenige Sekunden.",
                },
                {
                  step: "3",
                  title: "Smart-Routing entscheidet",
                  desc: "4-5 Sterne → Direkte Weiterleitung zu Google Reviews. 1-3 Sterne → Internes Feedback-Formular. So bleibt Kritik bei Ihnen.",
                },
              ].map((item) => (
      ...
      <section className="border-t border-white/5 bg-slate-900/30 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Warum Arztpraxen Revalo nutzen
            </h2>
          </div>
            ...
            {[
              {
                ...
                title: "Automatischer Bewertungsprozess",
                desc: "Nach jedem Patientenbesuch wird automatisch eine Bewertungsanfrage versendet. Sie müssen an nichts denken.",
              },
              {
                icon: <IconShield className="h-5 w-5" />,
                title: "DSGVO-konformer Versand",
                desc: "Versand via WhatsApp oder E-Mail — datenschutzkonform und auf EU-Servern gehostet. Keine Gesundheitsdaten.",
              },
              {
                icon: <IconMessage className="h-5 w-5" />,
                title: "Negatives Feedback intern",
                desc: "Unzufriedene Patienten geben ihr Feedback direkt an Sie — nicht öffentlich auf Google. Sie können reagieren, bevor es eskaliert.",
              },
              {
                icon: <IconMonitor className="h-5 w-5" />,
                title: "Übersichtliches Dashboard",
                desc: "Sehen Sie auf einen Blick: neue Bewertungen, Durchschnittsbewertung, Trends und offene Feedback-Fälle.",
              },
              {
                icon: <IconStethoscope className="h-5 w-5" />,
                title: "Unabhängig von Praxissoftware",
                desc: "Revalo funktioniert mit jedem Praxisverwaltungssystem. Kein Plugin, keine Schnittstelle nötig.",
              },
              {
                icon: <IconZap className="h-5 w-5" />,
                title: "Einrichtung in 5 Minuten",
                desc: "Kein IT-Wissen nötig. Google-Bewertungslink eintragen, QR-Code ausdrucken — fertig.",
              },
            ].map((v) => (
              <div
                key={v.title}
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Starten Sie jetzt mit Revalo für Ihre Arztpraxis
          </h2>
          <p className="mt-4 text-lg text-slate-400">
            Jetzt Demo anfragen — unverbindlich und persönlich.
          </p>
          <Link
            href="/kontakt"
